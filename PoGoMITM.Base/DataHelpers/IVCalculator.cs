...
namespace PoGoMITM.Base.DataHelpers
{
    ...
    public class IVCalculator
    {
        private struct BaseStats
        {
            ...
            public readonly int BaseStamina;
        ...
        private static double CalculateCpMultiplier(PokemonData poke)
        {
        ...
        private static double CalculateMaxCpMultiplier(PokemonData poke)
        {
            var baseStats = GetBaseStats(poke.PokemonId);
        ...
        private static BaseStats GetBaseStats(PokemonId id)
        {
            switch ((int)id)
            {
                case 1:
